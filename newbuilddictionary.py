...
def newbuilddictionary(spam_directory, ham_directory, dictionary_filename):
...
##    take out all punctation including @ , . : etc
        ...
        p = re.compile(r'[\W*_]')    ###*****ONLY CHANGE IS HERE *******##compiles so to use 0-9, any whitespace, and _ as spliters for lines into words
